			...
			<div class="card-body">
				<div class="row">
					<div class="col-12 col-sm-6">
						<h3 class="d-inline-block d-sm-none">Product Title Goes Right Here</h3>
						<div class="col-12">
							<div class="product-image-blowup">
								<img src="http://placehold.it/300x700?text=Product" class="product-image" alt="Product Image">
							</div>
						</div>
						<div class="col-12 product-image-thumbs">
							<div class="product-image-thumb active" ><img src="http://placehold.it/300x700?text=Product" alt="Product Image"></div>
					...
					<div class="col-12 col-sm-6">
						<h3 class="my-3">Product Title Goes Right Here</h3>
