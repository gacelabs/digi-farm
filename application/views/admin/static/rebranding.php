					...
					<div style="min-width:320px;max-width:600px;display:table-cell;vertical-align:top">
						<div style="width:100%!important">
							<div style="border-top:0px solid transparent;border-left:0px solid transparent;border-bottom:0px solid transparent;border-right:0px solid transparent;padding-top:5px;padding-bottom:5px;padding-right:0px;padding-left:0px">
								<div align="center" style="padding-right:0px;padding-left:0px">
									<a href="//send-data.co/" rel="noreferrer" target="_blank" data-saferedirecturl="https://www.google.com/url?q=//send-data.co/&amp;source=gmail&amp;ust=1566174810798000&amp;usg=AFQjCNHcw1_N9Ovdy6RffZepcTCWgxODng"> <img align="center" alt="Image" border="0" src="<?php echo base_url('assets/images/email/icon.png');?>" style="outline:none;text-decoration:none;clear:both;height:auto;float:none;border:none;width:100%;max-width:210px;display:block" title="Image" width="210">
									</a>
								</div>
							...
							<div style="border-top:0px solid transparent;border-left:0px solid transparent;border-bottom:0px solid transparent;border-right:0px solid transparent;padding-top:0px;padding-bottom:5px;padding-right:0px;padding-left:0px">
								<div style="color:#0d0d0d;font-family:'Montserrat','Trebuchet MS','Lucida Grande','Lucida Sans Unicode','Lucida Sans',Tahoma,sans-serif;line-height:120%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px">
									<div style="font-size:12px;line-height:14px;color:#0d0d0d;font-family:'Montserrat','Trebuchet MS','Lucida Grande','Lucida Sans Unicode','Lucida Sans',Tahoma,sans-serif">
										<p style="font-size:14px;line-height:33px;text-align:center;margin:0"><span style="font-size:28px"><strong><span style="line-height:33px;font-size:28px">We're RE-BRANDING!</span></strong></span></p>
									</div>
								</div>
								<div align="center">
								...
								<div style="color:#555555;font-family:'Montserrat','Trebuchet MS','Lucida Grande','Lucida Sans Unicode','Lucida Sans',Tahoma,sans-serif;line-height:150%;padding-top:10px;padding-right:10px;padding-bottom:10px;padding-left:10px">
									<div style="font-size:12px;line-height:18px;color:#555555;font-family:'Montserrat','Trebuchet MS','Lucida Grande','Lucida Sans Unicode','Lucida Sans',Tahoma,sans-serif">
										<p style="font-size:14px;line-height:21px;text-align:center;margin:0">Sorry for the <b style="color: blue;">inconvience</b>, the team decided to <b style="color: green;">RE-BRAND</b><br>our system <b style="color: black;">with a little new look and secured in HTTPS protocol</b><br>Now online for <b style="color: blue;">QUALITY SERVICE</b>.<br><br></p>
										<p style="font-size:14px;line-height:21px;text-align:center;margin:0">You can still login the app dashboard with <br>Your previous login credentials.</p>
									</div>
								</div>
								<div align="center" style="padding-top:25px;padding-right:10px;padding-bottom:10px;padding-left:10px">
									<a href="//app.send-data.co/accounts/login" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#a8bf6f;border-radius:4px;width:auto;width:auto;border-top:1px solid #a8bf6f;border-right:1px solid #a8bf6f;border-bottom:1px solid #a8bf6f;border-left:1px solid #a8bf6f;padding-top:15px;padding-bottom:15px;font-family:'Montserrat','Trebuchet MS','Lucida Grande','Lucida Sans Unicode','Lucida Sans',Tahoma,sans-serif;text-align:center;word-break:keep-all" rel="noreferrer" target="_blank" data-saferedirecturl="https://www.google.com/url?q=//app.send-data.co/accounts/login&amp;source=gmail&amp;ust=1566174810798000&amp;usg=AFQjCNFwp0afsF4ELLbPhakv5zmj1UUk0g"><span style="padding-left:15px;padding-right:15px;font-size:16px;display:inline-block">
										<span style="font-size:16px;line-height:32px">LOGIN TO YOUR ACCOUNT HERE</span>
									</span></a>
								</div>
												...
												<table align="center" cellpadding="0" cellspacing="0" style="table-layout:fixed;vertical-align:top;border-spacing:0;border-collapse:inherit;" valign="top">
													<tbody>
														<tr align="center" style="vertical-align:top;display:inline-block;text-align:center" valign="top">
															<td style="word-break:break-word;vertical-align:top;padding-bottom:5px;padding-right:3px;padding-left:3px;border-collapse:collapse" valign="top"><a href="https://www.facebook.com/send-data/" rel="noreferrer" target="_blank" data-saferedirecturl="https://www.google.com/url?q=https://www.facebook.com/send-data/&amp;source=gmail&amp;ust=1566174810798000&amp;usg=AFQjCNHW8WUSp8DSd5_kJKo2XEpL3EKAew"><img alt="Facebook" height="32" src="<?php echo base_url('assets/images/email/facebook@2x.png');?>" style="outline:none;text-decoration:none;clear:both;height:auto;float:none;border:none;display:block" title="Facebook" width="32" class="CToWUd"></a></td>
														</tr>
													</tbody>
												</table>
											</td>
