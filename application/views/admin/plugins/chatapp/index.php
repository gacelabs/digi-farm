		...
		<div class="col-md-12">
			...
			<!-- <div class="nav-tabs-custom">
				<ul class="nav nav-tabs">
					...
					<li><a href="#new_user" data-toggle="tab" aria-expanded="true">Add User</a></li>
				</ul>
														...
														<div class="box-body" style="height: 152px;">
															<?php if ($project->allowed == 0 OR $project->expired OR strtolower($package_type) != 'customed'): ?>
																<div class="range-field">
																	<input type="text" name="payload" id="<?php echo $index;?>" class="p-0 calculatorSlider" data-slider-min="1" data-slider-max="15" data-slider-step="1" data-slider-value="<?php echo $payload_value;?>" data-slider-handle="custom" style="width: 95%;">
